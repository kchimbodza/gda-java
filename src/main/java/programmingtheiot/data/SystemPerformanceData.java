...
/**
 * Represents system performance data including CPU, memory, and disk utilization.
 */
public class SystemPerformanceData extends BaseIotData implements Serializable
{
	...
	public SystemPerformanceData()
	{
		...
		super.setTypeID(ConfigConst.SYSTEM_PERF_TYPE);  // Use 9000 for SystemPerformanceData
	}

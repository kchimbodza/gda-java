...
/**
 * Resource handler for SystemPerformanceData updates from CDA.
 * Handles PUT requests to update system performance telemetry.
 */
public class UpdateSystemPerformanceResourceHandler extends CoapResource {
	...
	public void handleDELETE(CoapExchange context) {
		_Logger.info("handleDELETE called for SystemPerformanceData resource: " + super.getName());
		
		context.accept();
		context.respond(ResponseCode.DELETED, "SystemPerformanceData resource deleted");
	}
	
	@Override
	public void handleGET(CoapExchange context) {
		_Logger.info("handleGET called for SystemPerformanceData resource: " + super.getName());
		
		context.accept();
		
		// For now, return a simple response
		// In future, could retrieve cached SystemPerformanceData
		context.respond(ResponseCode.CONTENT, "SystemPerformanceData resource: " + super.getName());
	}
	
	@Override
	public void handlePOST(CoapExchange context) {
		_Logger.info("handlePOST called for SystemPerformanceData resource: " + super.getName());
	...
	public void handlePUT(CoapExchange context) {
		_Logger.info("handlePUT called for SystemPerformanceData resource: " + super.getName());
